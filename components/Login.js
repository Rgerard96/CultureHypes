...
export default function Login({ changeOpenModal }) {
  ...
  return (
    <div className='py-8 px-5 sm:flex sm:items-center bg-white max-w-max rounded-t-2xl sm:rounded-2xl transform sm:relative fixed bottom-0 animate-fadeUp sm:animate-fadeIn'>
      <Head>
