...
export default function Registration({ changeOpenModal }) {
 const closeModal = () => {
  ...
  return (
    <div className='max-h-4/5 p-5 overflow-y-scroll bg-white max-w-max rounded-t-2xl sm:rounded-2xl sm:relative fixed bottom-0 animate-fadeUp sm:animate-fadeIn'>
      <Head>
