...
export default function Registration({ changeOpenModal }) {
 const closeModal = () => {
  ...
  return (
    <div className='pt-10 pb-8 px-5 sm:flex sm:items-center bg-white max-w-max rounded-t-2xl sm:rounded-2xl sm:relative fixed bottom-0 animate-fadeUp sm:animate-fadeIn'>
      <Head>
